    ...
    <div class="container">
      <div class="staff__card">
        <div class="staff__avatar">
          <figcaption class="staff__location">
            SAN
          </figcaption>
        </div>
        ...
        <button
          class="staff__profile"
          @click="showProfile(staff.id)"
...
export default {
  ...
  setup() {
    ...
    const showProfile = (id) => {
      store.dispatch('setProfileId', id);
...
.staff {
  ...
  &__card {
    ...
    box-shadow: 0 0.1875rem 0.625rem #0000001a;
    display: flex;
    position: relative;
  ...
  &__info {
    ...
    @include breakpoint-up(large) {
      padding: 1.1875rem 0 0.75rem 1.375rem;
    }
